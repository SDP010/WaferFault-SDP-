from Raw_validation import RawDatavalidation
from DBOperation_Training import DBOperation
...
class train_validation:
    ...
    def train_validation(self):
        ...
        try:
            ...
            # replacing the blacks in the file with 'NULL' to insert into the table
